...
#Cargar datos
Avances.hasta.el.miercoles.28.de.octubre <- 
  read.csv("~/R Projects/Reportes_EMEFUT/Datos/Avances hasta el miercoles 28 de octubre.csv")
#Variable
datos <- Avances.hasta.el.miercoles.28.de.octubre
rm(Avances.hasta.el.miercoles.28.de.octubre)
...
datos[8666, "Fecha de contacto"] <- "2020-10-15"
datos[8962, "Fecha de contacto"] <- "2020-10-15"
datos[8718, "Fecha de contacto"] <- "2020-10-16"
datos[8827, "Fecha de contacto"] <- "2020-10-19"
datos[8890, "Fecha de contacto"] <- "2020-10-19"
datos[8881, "Fecha de contacto"] <- "2020-10-20"
datos[8923, "Fecha de contacto"] <- "2020-10-21"
datos[8950, "Fecha de contacto"] <- "2020-10-22"
datos[9007, "Fecha de contacto"] <- "2020-10-22"
datos[9047, "Fecha de contacto"] <- "2020-10-26"
datos[9117, "Fecha de contacto"] <- "2020-10-26"
datos[9136, "Fecha de contacto"] <- "2020-10-26"
datos[9182, "Fecha de contacto"] <- "2020-10-27"
datos[9183, "Fecha de contacto"] <- "2020-10-27"
datos[9214, "Fecha de contacto"] <- "2020-10-28"
datos[9238, "Fecha de contacto"] <- "2020-10-28"
datos=datos[-8235,] 
