...
#Cargar datos
Avances.hasta.el.lunes.28.de.septiembre <- 
  read.csv("~/R Projects/Reportes_EMEFUT/Datos/Avances hasta el lunes 28 de septiembre.csv")
#Variable
datos <- Avances.hasta.el.lunes.28.de.septiembre
rm(Avances.hasta.el.lunes.28.de.septiembre)
...
datos_septiembre<- datos %>%
  filter(datos$`Fecha de contacto`>"2020-09-14" &
           datos$`Fecha de contacto`<"2020-09-29")
#Resumen del reporte
Informe_Segunda_Quincena_Septiembre <- datos_septiembre %>%
  group_by(Sede,
           Categoría) %>%
...
#Limpiar la tabla
Informe_Segunda_Quincena_Septiembre <- subset.data.frame(Informe_Segunda_Quincena_Septiembre,
                                                 !is.na(Informe_Segunda_Quincena_Septiembre$Categoría))
#Tabla de informe
write.csv(Informe_Segunda_Quincena_Septiembre,
          file = "Tabla Segunda Quincena Septiembre")
rm(list = ls())
