...
#Cargar datos
Avances.hasta.el.miercoles.9.de.septiembre <- 
  read.csv("~/R Projects/Reportes_EMEFUT/Datos/Avances hasta el miercoles 9 de septiembre.csv")

#Variable
datos <- Avances.hasta.el.miercoles.9.de.septiembre
rm(Avances.hasta.el.miercoles.9.de.septiembre)
...
datos[5194, "Fecha de contacto"] <- "2020-08-04"
...
#Agregar mes
months(datos$`Fecha de contacto`)
datos$Mes_contacto <- months(datos$`Fecha de contacto`)
class(datos$Mes_contacto)
table(datos$Mes_contacto)
