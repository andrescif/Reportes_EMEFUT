...
#Cargar datos
Avances.hasta.el.domingo.2.de.agosto <- 
  read.csv("~/R Projects/Reportes_EMEFUT/Datos/Avances hasta el domingo 2 de agosto.csv")

#Variable
datos <- Avances.hasta.el.domingo.2.de.agosto
rm(Avances.hasta.el.domingo.2.de.agosto)
...
#Filtrar las fechas
datos_julio<- datos %>%
  filter(datos$`Fecha de contacto`>"2020-07-14" &
